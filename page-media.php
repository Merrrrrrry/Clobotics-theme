...
<div style="height: rem;"></div>
    ...
    <section class="media_content photos">
        ...
        <div class="downloadable-content">
            ...
            <a class="btn downloadable_content_link" download href="<?php echo esc_url($file["url"]); ?>" title="Downloadable image of <?php echo esc_attr($name); ?>"><img class="download_icon" src="<?php echo get_template_directory_uri(); ?>/media/icon_download.png" alt="Download icon">Download</a>
...
<div style="height: 6rem;"></div>
    ...
    <section class="media_content videos">    
        ...
        <div class="downloadable-content">
            <div class="preview_container"><div class="overlay blue"></div>            
            <img class="preview_img" src="<?php echo esc_url($preview["url"]); ?>" alt="Preview of '<?php echo esc_attr($name); ?>'"></div>
            <a class="btn downloadable_content_link" download href="<?php echo esc_url($file["url"]); ?>" title="Downloadable vidio clip of <?php echo esc_attr($name); ?>"><img class="download_icon" src="<?php echo get_template_directory_uri(); ?>/media/icon_download.png" alt="Download icon">Download</a>
            <p class="subtitle description_of_dwnld_file"><?php echo esc_html($name); ?></p>
        </div>
...
<!-- Media Certificates loop  (downloadable content section) -->
    <section class="media_content certificates">        
        ...
        <div class="downloadable-content">
            <div class="preview_container"><div class="overlay blue"></div>
            <img class="preview_img" src="<?php echo esc_url($preview["url"]); ?>" alt="Preview of '<?php echo esc_attr($name); ?>'"></div>
            <a class="btn downloadable_content_link" download href="<?php echo esc_url($file["url"]); ?>" title="Downloadable certificate '<?php echo esc_attr($name); ?>'"><img class="download_icon" src="<?php echo get_template_directory_uri(); ?>/media/icon_download.png" alt="Download icon">Download</a>
            <p class="subtitle description_of_dwnld_file"><?php echo esc_html($name); ?></p>
        </div>
...
<!-- Media Company presentations loop  (downloadable content section) -->
    <section class="media_content presentations">        
        ...
        <div class="downloadable-content">
            <div class="preview_container"><div class="overlay blue"></div>
            <img class="preview_img" src="<?php echo esc_url($preview["url"]); ?>" alt="Preview of '<?php echo esc_attr($name); ?>'"></div>
            <a class="btn downloadable_content_link" download href="<?php echo esc_url($file["url"]); ?>" title="Downloadable presentation '<?php echo esc_attr($name); ?>'"><img class="download_icon" src="<?php echo get_template_directory_uri(); ?>/media/icon_download.png" alt="Download icon">Download</a>
            <p class="subtitle description_of_dwnld_file"><?php echo esc_html($name); ?></p>
        </div>
...
<!-- Media Mission, Vision and Values posters loop  (downloadable content section) -->
    <section class="media_content posters">        
        ...
        <div class="downloadable-content">
            <div class="preview_container"><div class="overlay blue"></div>
            <img class="preview_img" src="<?php echo esc_url($preview["url"]); ?>" alt="Preview of '<?php echo esc_attr($name); ?>'"></div>
            <a class="btn downloadable_content_link" download href="<?php echo esc_url($file["url"]); ?>" title="Downloadable posters'<?php echo esc_attr($name); ?>'"><img class="download_icon" src="<?php echo get_template_directory_uri(); ?>/media/icon_download.png" alt="Download icon">Download</a>
            <p class="subtitle description_of_dwnld_file"><?php echo esc_html($name); ?></p>
        </div>
...
<!-- Media Additional files loop  (downloadable content section) -->
    <section class="media_content additional_files">        
        ...
        <div class="downloadable-content">
            <div class="preview_container"><div class="overlay blue"></div>
            <img class="preview_img" src="<?php echo esc_url($preview["url"]); ?>" alt="Preview of '<?php echo esc_attr($name); ?>'"></div>
            <a class="btn downloadable_content_link" download href="<?php echo esc_url($file["url"]); ?>" title="Downloadable file '<?php echo esc_attr($name); ?>'"><img class="download_icon" src="<?php echo get_template_directory_uri(); ?>/media/icon_download.png" alt="Download icon">Download</a>
            <p class="subtitle description_of_dwnld_file"><?php echo esc_html($name); ?></p>
        </div>
