...
<div class="we_operate_globally_container"> 
    ...
    <ul class="inline img_selector">
        ...
        <img class="we_operate_globally-img" id="image_of_our_offices" src="<?php $image = the_field('image_of_our_offices_we_operate_globally_section'); print_r($image); echo esc_url($image["url"]); ?>" alt="Image of our offices (We operate globally section)" /> 
