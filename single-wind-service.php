    ...
    <article <?php post_class(); ?>>
        ...
        <div class="service-keypoints">
            <div class="keypoint">
                ...
                if ($icon1_id) :
                    $icon1 = wp_get_attachment_image_src($icon1_id, 'full');
                    if ($icon1) : ?>
                        <img src="<?php echo esc_url($icon1[0]); ?>" alt="<?php echo esc_attr(get_post_meta($icon1_id, '_wp_attachment_image_alt', true)); ?>">
                    <?php endif; ?>
                <?php endif; ?>
            ...
            <div class="keypoint">
                ...
                if ($icon2_id) :
                    $icon2 = wp_get_attachment_image_src($icon2_id, 'full');
                    if ($icon2) : ?>
                        <img src="<?php echo esc_url($icon2[0]); ?>" alt="<?php echo esc_attr(get_post_meta($icon2_id, '_wp_attachment_image_alt', true)); ?>">
                    <?php endif; ?>
                <?php endif; ?>
            ...
            <div class="keypoint">
                ...
                if ($icon3_id) :
                    $icon3 = wp_get_attachment_image_src($icon3_id, 'full');
                    if ($icon3) : ?>
                        <img src="<?php echo esc_url($icon3[0]); ?>" alt="<?php echo esc_attr(get_post_meta($icon3_id, '_wp_attachment_image_alt', true)); ?>">
                    <?php endif; ?>
                <?php endif; ?>
